...
Scheme
{
	...
	Borders
	{
		...
		TFThinLineBorder  ///LEFT OFF HERE NOT SURE WHAT IT DID LOL
		{
			"bordertype"			"scalable_image"
			"backgroundtype"		"2"
		...
		TFFatLineBorderOpaque ///NOT SURE WHAT THIS DID EITHER LOL
		{
			"bordertype"			"scalable_image"
			"backgroundtype"		"2"
		...
		TFFatLineBorder ///NOT SURE WHAT THIS DOES EITHER BibleThump
		{
			"bordertype"			"scalable_image"
			"backgroundtype"		"2"
		...
		// Unique ------------------------------------------------------------------------------------------------ THIS IS WHERE YOU LEFT OFF NIGGA
